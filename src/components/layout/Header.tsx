            ...
            >
              {!isLoggedIn ? (
                ...
                <>
                  ...
                  <Link onClick={() => setShowAccount(false)} href="/support" className="block rounded-lg px-3 py-2 text-sm font-semibold text-gray-900 hover:bg-black/5 dark:text-gray-100 dark:hover:bg-white/10">Support</Link>
                  {role === "vendor" ? (
